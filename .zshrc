...
alias htb='sudo openvpn ~/academy-regularUS5.ovpn'
alias sharedfolder='sudo mount -t fuse.vmhgfs-fuse .host:/ /mnt/hgfs -o allow_other'
alias rdp='xfreerdp3 /network:modem -wallpaper -themes -fonts -menu-anims -window-drag'
